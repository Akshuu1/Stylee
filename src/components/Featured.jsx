        ...
        <div className="w-full px-20 border-b-[1px] border-zinc-700 pb-15">
            ...
            <div className="cards w-full flex gap-10 mt-10">
                ...
                className="cardContainer w-1/2 relative  ">
                    ...
                    <div className="overflow-hidden w-full h-full  rounded-xl scale-90">
                        <img src="src/assets/happy-face-emoji-1heQMhex2Ko-unsplash.jpg" alt="" />    
                    </div>   
                </motion.div>
                <motion.div 
                onHoverStart={()=>handleHolver(1)} 
                ...
                className="cardContainer w-1/2 relative  ">
                    ...
                    <div className="overflow-hidden w-full h-full rounded-xl scale-90 ">
                        <img src="src/assets/nellie-adamyan-J1YzvR1RWvo-unsplash.jpg" alt="Street Style"  className='object-cover object-bottom'/>    
                    </div>   
                </motion.div>
            </div>
        </div>
