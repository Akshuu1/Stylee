...
const Sets = () => {
  return (
    <div id='Knowledge' data-scroll data-scroll-section data-scroll-speed=".2" className="bg-[#CDEA68] rounded-tl-3xl rounded-tr-3xl w-full text-black py-10 px-10">
      ...
      <div className=" flex justify-center items-center p-10 text-zinc-800">
        <h1 className='absolute z-[-100] mb-[30vw] mt-[10vw] text-[15vw] '>Let's learn</h1>
        <Eyes minimal={true} />
      </div>
    </div>
  )
